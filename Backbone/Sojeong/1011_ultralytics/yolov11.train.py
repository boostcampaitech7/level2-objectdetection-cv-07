...
# Initialize WandB
wandb.init(project=wandb_project, entity=wandb_entity, name="yolov11")

# Load a model
model = YOLO("/data/ephemeral/home/Sojeong/level2-objectdetection-cv-07/Backbone/Sojeong/1011_ultralytics/yolo11x.pt")
...
train_results = model.train(
    ...
    amp=False,
    name="yolov11_exp1",  # 새로운 실행에 대한 이름 지정
...
# python /data/ephemeral/home/Sojeong/level2-objectdetection-cv-07/Backbone/Sojeong/1011_ultralytics/yolov11.train.py