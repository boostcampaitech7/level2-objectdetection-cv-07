...
python ./tools/train.py /data/ephemeral/home/Sojeong/level2-objectdetection-cv-07/Backbone/Sojeong/co-dino/mmdetection/projects/CO-DETR/configs/codino/co_dino_5scale_swin_l_16xb1_1x_coco.py \
    ...
    --ann_file /data/ephemeral/home/Sojeong/level2-objectdetection-cv-07/Split_data/train_0_5.json \
    --batch_size 2 \
    --num_classes 10 \
    --work_dir /data/ephemeral/home/Sojeong/level2-objectdetection-cv-07/Backbone/Sojeong/co-dino/mmdetection/work_dirs/co_dino \
    --eval_ann_file /data/ephemeral/home/Sojeong/level2-objectdetection-cv-07/Split_data/valid_0_5.json \
    --test_ann_file /data/ephemeral/home/data/dataset/test.json \
    --image_size 512 512 \
    --num_workers 2 \
