...
# 상위 폴더를 sys.path에 추가
sys.path.append('/data/ephemeral/home/Jihwan/level2-objectdetection-cv-07/CoDetr')
...
def get_config():
    ...
    cfg = Config.fromfile('/data/ephemeral/home/Jihwan/level2-objectdetection-cv-07/mmdetection/detr_experiment2/model_configs/co_dino_5scale_lsj_r50_1x_coco.py')
    ...
    cfg.model.roi_head[0].mask_head = None
