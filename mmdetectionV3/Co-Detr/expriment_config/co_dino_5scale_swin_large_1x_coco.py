...
def get_config():
    ...
    cfg = Config.fromfile('/data/ephemeral/home/Jihwan/level2-objectdetection-cv-07/CoDetr/detr_experiment2/model_configs/co_dino_5scale_swin_large_1x_coco.py')
