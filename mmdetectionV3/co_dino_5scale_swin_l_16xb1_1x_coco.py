...
default_hooks = dict(
    checkpoint=dict(
        ...
        max_keep_ckpts=3,
        type='CheckpointHook'),
    logger=dict(_scope_='mmdet', interval=500, type='LoggerHook'),
...
train_dataloader = dict(
    ...
    dataset=dict(
        ann_file=
        '/data/ephemeral/home/Jihwan/level2-objectdetection-cv-07/Split_data/train_0_5.json',
        backend_args=None,
...
val_dataloader = dict(
    ...
    dataset=dict(
        _scope_='mmdet',
        ann_file=
        '/data/ephemeral/home/Jihwan/level2-objectdetection-cv-07/Split_data/valid_0_5.json',
        backend_args=None,
        data_prefix=dict(img='val2017/'),
        data_root='/data/ephemeral/home/dataset/',
        metainfo=dict(
...
work_dir = '/data/ephemeral/home/Jihwan/level2-objectdetection-cv-07/mmdetectionV3'
