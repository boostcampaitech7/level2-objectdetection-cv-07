...
class register_datasets:
    # Register Dataset
    try:
        register_coco_instances('coco_trash_train', {}, '/data/ephemeral/home/Seungcheol/level2-objectdetection-cv-07/Split_data/train_10.json', '/data/ephemeral/home/data/dataset/')
